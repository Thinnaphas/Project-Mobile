...
class form : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nSername = intent.getStringExtra("nSername")
        nPhone= intent.getStringExtra("nPhone")
                ...
                serv.insertorder(
                    ...
                    override fun onResponse(
                        ...
                        if (response.isSuccessful) {
                            ...
                            intent.putExtra("mSername",nSername)
                            intent.putExtra("mPhone",nPhone)
